...
try {
  ...
  for (const name of [
    ...
    ...["organizations", "users", "projects", "workflows", "websites", "qa", "usage", "finance", "write-brief", "workflow-launch", "settings", "employees", "settings-laptop", "audit", "system"].map(name => `kleo-console-${name}.png`),
